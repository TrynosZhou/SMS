...
const uniqueClassesMap = new Map<string, any>();
  ...
  /** Keep subject dropdown populated; filter by class when one is selected. */
  private refreshSubjectDropdown(): void {
    if (!this.selectedClassId) {
      this.subjects = this.sortSubjects(this.allSubjects || []);
      this.cdr.markForCheck();
      return;
    }
