...
// Search and selection
  ...
  ngOnInit(): void {
    activatePageLoad(this.router, this.destroy$, '/students/transfer', () => {
      this.loadStudents();
      this.loadClasses();
    });
  }
        ...
        next: (response: any) => {
          ...
          if (this.selectedStudent) {
            const currentClassId =
              this.selectedStudent.classId ||
              this.selectedStudent.class?.id ||
              this.selectedStudent.classEntity?.id;
            if (currentClassId) {
