...
const ensureModuleAccessDefaults = (current?: Settings['moduleAccess'] | null): Settings['moduleAccess'] => {
  ...
  return {
    ...
    director: { ...DEFAULT_MODULE_ACCESS?.director, ...(existing.director || {}) },
    headmaster: { ...DEFAULT_MODULE_ACCESS?.headmaster, ...(existing.headmaster || {}) },
    deputy_headmaster: {
      ...DEFAULT_MODULE_ACCESS?.deputy_headmaster,
      ...(existing.deputy_headmaster || {}),
    },
