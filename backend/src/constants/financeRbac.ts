...
export const FINANCE_PAGES: FinancePageDef[] = [
  ...
  {
    key: 'invoiceSyncRemediation',
    label: 'Invoice Sync Remediation',
    group: 'sensitiveActions',
    sensitive: true,
    description: 'Reverse fictitious payments and credit duplicated tuition from transport/DH sync bug',
  },
...
const ACCOUNTANT_FINANCE_DEFAULTS: Record<string, { view: boolean; edit: boolean }> = {
  ...
  invoiceSyncRemediation: { view: false, edit: false },
